...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('ynmp_candidacy', (
            ('id', orm['ynmp.candidacy:id']),
            ('ynmp_constituency', orm['ynmp.candidacy:ynmp_constituency']),
            ('candidate', orm['ynmp.candidacy:candidate']),
        ))
        db.send_create_signal('ynmp', ['Candidacy'])
        
        # Adding model 'YNMPConstituency'
        db.create_table('ynmp_ynmpconstituency', (
            ('id', orm['ynmp.ynmpconstituency:id']),
            ('constituency', orm['ynmp.ynmpconstituency:constituency']),
            ('ynmp_seat_id', orm['ynmp.ynmpconstituency:ynmp_seat_id']),
        ))
        db.send_create_signal('ynmp', ['YNMPConstituency'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('ynmp_candidacy')
        
        # Deleting model 'YNMPConstituency'
        db.delete_table('ynmp_ynmpconstituency')
