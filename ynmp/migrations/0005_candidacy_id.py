...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Candidacy.ynmp_id'
        db.add_column('ynmp_candidacy', 'ynmp_id', orm['ynmp.candidacy:ynmp_id'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Candidacy.ynmp_id'
        db.delete_column('ynmp_candidacy', 'ynmp_id')
