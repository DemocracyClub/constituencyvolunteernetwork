...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CommentSimple.removal_reason'
        db.add_column('custom_comments', 'removal_reason', orm['comments_custom.commentsimple:removal_reason'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'CommentSimple.removal_reason'
        db.delete_column('custom_comments', 'removal_reason')
    ...
    models = {
        ...
        'comments_custom.commentsimple': {
            ...
            'removal_reason': ('django.db.models.fields.CharField', [], {'default': "'none'", 'max_length': '20'}),
