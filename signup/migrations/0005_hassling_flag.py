...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomUser.hassling'
        db.add_column('signup_customuser', 'hassling', orm['signup.customuser:hassling'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'CustomUser.hassling'
        db.delete_column('signup_customuser', 'hassling')
