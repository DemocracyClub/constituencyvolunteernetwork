...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UploadedLeaflet.thumb_url'
        db.add_column('tsc_uploadedleaflet', 'thumb_url', orm['tsc.uploadedleaflet:thumb_url'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'UploadedLeaflet.thumb_url'
        db.delete_column('tsc_uploadedleaflet', 'thumb_url')
