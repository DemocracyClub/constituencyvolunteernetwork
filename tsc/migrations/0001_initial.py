...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UploadedLeaflet'
        db.create_table('tsc_uploadedleaflet', (
            ('id', orm['tsc.UploadedLeaflet:id']),
            ('url', orm['tsc.UploadedLeaflet:url']),
            ('user', orm['tsc.UploadedLeaflet:user']),
            ('date', orm['tsc.UploadedLeaflet:date']),
        ))
        db.send_create_signal('tsc', ['UploadedLeaflet'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'UploadedLeaflet'
        db.delete_table('tsc_uploadedleaflet')
