...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UploadedLeaflet.constituency'
        db.add_column('tsc_uploadedleaflet', 'constituency', orm['tsc.uploadedleaflet:constituency'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'UploadedLeaflet.constituency'
        db.delete_column('tsc_uploadedleaflet', 'constituency_id')
