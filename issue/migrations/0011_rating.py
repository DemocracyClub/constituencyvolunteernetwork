...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RefinedIssue.rating'
        db.add_column('issue_refinedissue', 'rating', orm['issue.refinedissue:rating'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'RefinedIssue.rating'
        db.delete_column('issue_refinedissue', 'rating')
