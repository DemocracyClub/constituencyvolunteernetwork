...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RefinedIssue.created_at'
        db.add_column('issue_refinedissue', 'created_at', orm['issue.refinedissue:created_at'])
        
        # Adding field 'RefinedIssue.updated_at'
        db.add_column('issue_refinedissue', 'updated_at', orm['issue.refinedissue:updated_at'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'RefinedIssue.created_at'
        db.delete_column('issue_refinedissue', 'created_at')
        
        # Deleting field 'RefinedIssue.updated_at'
        db.delete_column('issue_refinedissue', 'updated_at')
