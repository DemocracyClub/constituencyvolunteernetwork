...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RefinedIssue.fine_tuned'
        db.add_column('issue_refinedissue', 'fine_tuned', orm['issue.refinedissue:fine_tuned'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'RefinedIssue.fine_tuned'
        db.delete_column('issue_refinedissue', 'fine_tuned')
