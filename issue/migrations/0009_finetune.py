...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ConstituencyIssueCompletion.fine_tuned'
        db.add_column('issue_constituencyissuecompletion', 'fine_tuned', orm['issue.constituencyissuecompletion:fine_tuned'])
        
        # Adding field 'RefinedIssue.status'
        db.add_column('issue_refinedissue', 'status', orm['issue.refinedissue:status'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'ConstituencyIssueCompletion.fine_tuned'
        db.delete_column('issue_constituencyissuecompletion', 'fine_tuned')
        
        # Deleting field 'RefinedIssue.status'
        db.delete_column('issue_refinedissue', 'status')
