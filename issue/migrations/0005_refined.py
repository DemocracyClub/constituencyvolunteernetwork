...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RefinedIssue'
        db.create_table('issue_refinedissue', (
            ('id', orm['issue.refinedissue:id']),
            ('question', orm['issue.refinedissue:question']),
            ('reference_url', orm['issue.refinedissue:reference_url']),
            ('constituency', orm['issue.refinedissue:constituency']),
            ('based_on', orm['issue.refinedissue:based_on']),
            ('moderator', orm['issue.refinedissue:moderator']),
        ))
        db.send_create_signal('issue', ['RefinedIssue'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'RefinedIssue'
        db.delete_table('issue_refinedissue')
