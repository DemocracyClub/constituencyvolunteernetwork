...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SurveyInvite.candidacy'
        db.add_column('twfy_surveyinvite', 'candidacy', orm['twfy.surveyinvite:candidacy'])
        
        # Deleting field 'SurveyInvite.candidate'
        db.delete_column('twfy_surveyinvite', 'candidate_id')
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'SurveyInvite.candidacy'
        db.delete_column('twfy_surveyinvite', 'candidacy_id')
        
        # Adding field 'SurveyInvite.candidate'
        db.add_column('twfy_surveyinvite', 'candidate', orm['twfy.surveyinvite:candidate'])
