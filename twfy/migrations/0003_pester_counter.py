...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SurveyInvite.pester_emails_sent'
        db.add_column('twfy_surveyinvite', 'pester_emails_sent', orm['twfy.surveyinvite:pester_emails_sent'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'SurveyInvite.pester_emails_sent'
        db.delete_column('twfy_surveyinvite', 'pester_emails_sent')
