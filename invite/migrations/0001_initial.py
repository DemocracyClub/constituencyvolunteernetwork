...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('invite_invitation', (
            ('id', orm['invite.Invitation:id']),
            ('email', orm['invite.Invitation:email']),
            ('user_from', orm['invite.Invitation:user_from']),
        ))
    ...
    models = {
        ...
        'invite.invitation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user_from': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['signup.CustomUser']"})
        },
        'signup.constituency': {
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
