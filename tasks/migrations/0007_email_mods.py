...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TaskEmailUser'
        db.create_table('tasks_taskemailuser', (
            ('id', orm['tasks.taskemailuser:id']),
            ('task_email', orm['tasks.taskemailuser:task_email']),
            ('task_user', orm['tasks.taskemailuser:task_user']),
            ('date_added', orm['tasks.taskemailuser:date_added']),
            ('date_sent', orm['tasks.taskemailuser:date_sent']),
        ))
        db.send_create_signal('tasks', ['TaskEmailUser'])
        
        # Adding field 'TaskEmail.task'
        db.add_column('tasks_taskemail', 'task', orm['tasks.taskemail:task'])
        
        # Adding field 'TaskEmail.task_user_state'
        db.add_column('tasks_taskemail', 'task_user_state', orm['tasks.taskemail:task_user_state'])
        
        # Adding field 'TaskEmail.email_type'
        db.add_column('tasks_taskemail', 'email_type', orm['tasks.taskemail:email_type'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'TaskEmailUser'
        db.delete_table('tasks_taskemailuser')
        
        # Deleting field 'TaskEmail.task'
        db.delete_column('tasks_taskemail', 'task_id')
        
        # Deleting field 'TaskEmail.task_user_state'
        db.delete_column('tasks_taskemail', 'task_user_state')
        
        # Deleting field 'TaskEmail.email_type'
        db.delete_column('tasks_taskemail', 'email_type')
    ...
    models = {
        ...
        'tasks.taskemail': {
            ...
            'task_user_state': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
