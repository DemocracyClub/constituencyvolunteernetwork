...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.decorator_class'
        # (to signature: django.db.models.fields.CharField(max_length=180, null=True, blank=True))
        db.alter_column('tasks_task', 'decorator_class', orm['tasks.task:decorator_class'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Task.decorator_class'
        # (to signature: django.db.models.fields.CharField(max_length=180))
        db.alter_column('tasks_task', 'decorator_class', orm['tasks.task:decorator_class'])
    ...
    models = {
        ...
        'tasks.taskuser': {
            ...
            'emails_opened': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
